## How to run application?
    ...
    - cd poki-docs composer install
    - cp .env.example .env
    - Update the .env file variable e.g.
        POKEMON_API_URL= "https://pokeapi.co/api/v2"
    - php artisan key:generate

## How to use SASS in laravel with Vite?

    1. Navigate to resources/ folder and create scss/example.scss
    2. Navigate to Vite.config.js and inclose the file example.scss inside the input array.
    3. npm install
    4. npm add -D sass
    5. npm run dev
